...
import com.bomb.springjpasmpl.modules.account.WithAccount;
...
public class StudyControllerTest {
    ...
    void createStudy_success() throws Exception {
        ...
        Assertions.assertTrue(study.getManagers().contains(account));
    }
    ...
    void joinStudy() throws Exception {
        ...
        Account keesun = accountRepository.findByNickname("keesun");
        Assertions.assertTrue(study.getMembers().contains(keesun));
    }
